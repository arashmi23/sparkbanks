...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#services"> Services ffered</a>
          </li>
          <li class="nav-item">
  ...
  <section id="home" class="topContent">
    <div class="mainHeading">
      <div>
        <span class="main-content" align="center">WELCOME TO SPARKS BANK</span>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 mx-auto">
          <img class=" mt-3 " style="width:1000px;"  src="./images/bank.jpg" alt="SPARK FOUNDATION BANK">
        </div>
    ...
    <div class="container  text-center">
      <div class="row">
        <div class="card col-md-3 mx-auto" style="width: 22rem; height: 22rem; " >
          <img src="./images/users.ico" class="card-img-top mt-3 img" alt="Responsive image">
          <div class="card-body">
